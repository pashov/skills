 ...
 * estimate_cost.js
 *
 * Prints and writes a rough cost estimate for an ai-fuzzing run based on the
...
// Derived from observed ai-fuzzing runs in ai-fuzzing-workspace/.
const STAGES = [
