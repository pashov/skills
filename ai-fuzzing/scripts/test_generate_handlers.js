...
function makeProject(name) {
    ...
    const metaDir = path.join(dir, 'ai_fuzzing_data');
    const suiteDir = path.join(dir, 'test', 'ai_fuzzing', 'handlers');
...
function testCreatesHandlerDirIfMissing() {
    ...
    run(dir);
    const handlerPath = path.join(dir, 'test', 'ai_fuzzing', 'handlers', 'TokenHandler.sol');
