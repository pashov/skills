...
62 attack vectors. For each: detection pattern (what to look for in code) and false-positive signals (what makes it NOT a vulnerability even if the pattern matches).
...
**50. Transient Storage Low-Gas Reentrancy (EIP-1153)**
...
**51. Force-Feeding ETH via selfdestruct or coinbase**
...
**53. extcodesize Zero / isContract Bypass in Constructor**
...
**55. Blacklistable or Pausable Token in Critical Payment Path**
...
**58. EIP-2612 Permit Front-Run Causing DoS**
...
**59. ecrecover Returns address(0) on Invalid Signature**
...
**60. Griefing via Dust Deposits Resetting Timelocks or Cooldowns**
...
**61. Insufficient Gas Forwarding / 63/64 Rule Exploitation**
...
**62. Chainlink Feed Deprecation / Wrong Decimal Assumption**
